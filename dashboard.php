        ...
        <div class="row">
            <div class="col-md-3 profile-img-container">
                <?php if (!empty($user['profile_picture'])) { ?>
                    <img src="<?= $user['profile_picture'] ?>" alt="Profile Image" class="profile-img">
                <?php } else { ?>
            ...
            <div class="col-md-9">
                <div class="row no-gutters justify-content-between align-items-end">
                    <div class="profile">
                        <div id="full_name" class="name"><?= $user['full_name'] ?></div>
                        <div id="email" class="email"><?= $user['email'] ?></div>
                        <div id="phone" class="phone"><?= $user['phone'] ?></div>
                        <div id="college_name" class="college"><?= $user['college_name'] ?></div>
                    </div>
                    <div class="edit">
